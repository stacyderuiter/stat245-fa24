...
format: 
  revealjs:
    ...
    title-slide-attributes: 
      data-background-image: "https://stacyderuiter.github.io/stat245-fa24/CalvinUniv-vert-full-color-NoDate.png"
...
If you grab the example quarto presentation file from an online source,
it seems the YAML header isn't preserved. Copy/paste from the next slide
to the very start of your qmd file!
...
-   If you want the Calvin colors/theme/logo, download the file
    <https://stacyderuiter.github.io/stat245-fa24/calvin-slides.scss>
...
> > If you would like to include a direct quote from the paper, you can
> > do it like this -- start with two greater-than signs, and then add
> > the text you want to quote. It will be formatted like a block quote
> > (check out the rendered version to see the effect).
...
-   Don't forget to **Submit your rendered slides on Moodle at the end
    of class.**
