---
title: "STAT 245 Project Partners, Fall 2024"
output: 
  learnr::tutorial:
    theme: "yeti"
    allow_skip: TRUE
...
### Contact Person: Renita Reed-Thompson
...
This past summer, two Calvin students working with Plaster Creek Stewards collected a lot of soil chemistry data from different aged curb-cut rain gardens. They have determined levels of many different potential pollutants in the rain garden soil because of concerns that these gardens maybe accumulating toxins over time. This project will involve relating contaminant levels to factors like garden age, site, and soil type to try to understand whether and how certain toxins are accumulating in the gardens' soil.
