...
## YAML Header
If you grab the example quarto presentation file, it seems the YAML header isn't preserved. 

Here is how it should look:

```{r, echo = FALSE, out.width='40%'}
knitr::include_graphics('https://stacyderuiter.github.io/stat245-sp24/quarto-pres-header.png')
```
